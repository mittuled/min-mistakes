...
```ruby
gem "minimal-mistakes-jekyll", :git => "https://github.com/mittuled/mini-mistakes.git", :branch => "feature/theme-gem"`
```
...
- Replace `<site root>/index.html` with a modified [Minimal Mistakes `index.html`](https://github.com/mittuled/mini-mistakes/blob/master/index.html).
...
[File an issue](https://github.com/mittuled/mini-mistakes/issues/new){: .btn .btn--info .btn--large}
