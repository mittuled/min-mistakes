...
| Name                 | Layout | Example |
| -------------------- | ------ | ------ |
| [Posts Archive](https://mittuled.github.io/mini-mistakes/year-archive/) | `layout: posts` | [year-archive.md](https://github.com/mittuled/mini-mistakes/blob/master/docs/_pages/year-archive.md) |
| [Categories Archive](https://mittuled.github.io/mini-mistakes/categories/) | `layout: categories` | [category-archive.md](https://github.com/mittuled/mini-mistakes/blob/master/docs/_pages/category-archive.md) |
| [Category Archive](https://mittuled.github.io/mini-mistakes/categories/edge-case/) | `layout: category` | [edge-case.md](https://github.com/mittuled/mini-mistakes/blob/master/docs/_pages/edge-case.md) |
| [Tags Archive](https://mittuled.github.io/mini-mistakes/tags/) | `layout: tags` | [tag-archive.md](https://github.com/mittuled/mini-mistakes/blob/master/docs/_pages/tag-archive.md) |
| [Tag Archive](https://mittuled.github.io/mini-mistakes/tags/markup/) | `layout: tag` | [markup.md](https://github.com/mittuled/mini-mistakes/blob/master/docs/_pages/markup.md) |
| [Collection Archive](https://mittuled.github.io/mini-mistakes/recipes-archive/) | `layout: collection` | [recipes-archive.md](https://github.com/mittuled/mini-mistakes/blob/master/docs/_pages/recipes-archive.md) |
...
A page with a search form. Add `layout: search` to the YAML Front Matter similar to [this example](https://github.com/mittuled/mini-mistakes/blob/master/test/_pages/search.md) on the test site.
...
If you'd like to add, remove, or change the order of these default links you can do so by editing [`_includes/social-share.html`](https://github.com/mittuled/mini-mistakes/blob/master/_includes/social-share.html).
