...
1. Fork the [Minimal Mistakes repo](http://github.com/mittuled/mini-mistakes/fork).
...
1. [Download Minimal Mistakes](https://github.com/mittuled/mini-mistakes/releases/tag/2.2.1) and unzip.
...
```yaml
url: http://mittuled.github.io/mini-mistakes
