...
The English[^yaml-anchors] main keys in [`_data/ui-text.yml`](https://github.com/mittuled/mini-mistakes/blob/master/_data/ui-text.yml) are translated in the following languages:
